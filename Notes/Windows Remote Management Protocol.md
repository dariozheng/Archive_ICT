...
WinRM and the Intelligent Platform Management Interface (IPMI) standard, along with the Event Collector service are components of the set of features known as Hardware management.
