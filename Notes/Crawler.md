...
Web search engines and some other websites use <mark style="background: #BBFABBA6;">Web crawling or spidering software to update their web content or indices of other sites' web content</mark>. Web crawlers copy pages for processing by a search engine, which indexes the downloaded pages so that users can search more efficiently.
...
Mechanisms exist for public sites not wishing to be crawled to make this known to the crawling agent. For example, <mark style="background: #ABF7F7A6;">including a <strong>robots.txt</strong> file can request bots to index only parts of a website, or nothing at all</mark>.
